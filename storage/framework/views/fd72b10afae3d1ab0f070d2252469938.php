...
<nav class="bg-white border-b border-[#e2e8f0] sticky top-0 z-50" x-data="{ open: false }">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between gap-2">
        ...
        <a <?php echo e(spa()); ?> href="/" class="shrink-0">
        ...
        <div class="hidden lg:flex items-center gap-1 flex-1 justify-center">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                ?>
                <a <?php echo e(spa()); ?> href="<?php echo e(route($link['route'])); ?>"
                    class="text-[.95rem] font-semibold px-4 py-[.6rem] rounded-lg no-underline transition-colors whitespace-nowrap
                           <?php echo e($active ? 'bg-[#eff6ff] text-[#1b3a6b]' : 'text-[#475569] hover:bg-[#eff6ff] hover:text-[#1b3a6b]'); ?>">
        ...
        <div class="flex items-center gap-2 shrink-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e($authHomeUrl); ?>"
                    ...
                    <img class="w-9 h-9 rounded-full object-cover border border-[#e2e8f0]"
                        src="<?php echo e(auth()->user()->getFilamentAvatarUrl()); ?>" alt="avatar">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo e(filament()->getPanel('member')->getLoginUrl()); ?>?redirectTo=<?php echo e(url()->current()); ?>"
                ...
                <a href="<?php echo e(filament()->getPanel('member')->getRegistrationUrl()); ?>?redirectTo=<?php echo e(url()->current()); ?>"
        ...
        <div class="flex flex-col gap-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                    ...
                    $active  = request()->routeIs($pattern);
                ?>
                <a <?php echo e(spa()); ?> href="<?php echo e(route($link['route'])); ?>" @click="open = false"
