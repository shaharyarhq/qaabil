    ...
    <div class="flex-1 flex items-center justify-center px-6 py-16 relative overflow-hidden min-h-[80vh]">
        ...
        <div class="relative z-10 text-center max-w-105">
            ...
            <div class="text-[5rem] font-black text-[#1b3a6b] leading-none mb-2">
                4<span class="text-[#f59e0b]">0</span>4
            </div>
            ...
            <div class="flex items-center justify-center gap-3 flex-wrap">
                <a href="{{ route('home') }}"
                    class="inline-flex items-center gap-1.5 bg-[#1b3a6b]/[0.07] hover:bg-[#1b3a6b]/12 text-[#1b3a6b]/70 text-sm font-semibold px-6 py-2.5 rounded-xl border border-[#1b3a6b]/10 transition-colors">
