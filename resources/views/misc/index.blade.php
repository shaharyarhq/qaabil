...
<head>
    ...
    <style>
        ...
        /* card hover title color — child selector */
        ...
        /* custom grid — 12-col mixed layout, can't be expressed with Tailwind alone */
        .courses-grid {
            display: grid;
        ...
        /* band gradients */
        .band-1 {
            background: linear-gradient(145deg, #1b3a6b 0%, #2d5fa8 100%);
        }

        .band-2 {
            background: linear-gradient(145deg, #163354 0%, #1f6b96 100%);
        }

        .band-3 {
            background: linear-gradient(145deg, #1e2f5a 0%, #384faa 100%);
        }

        .band-4 {
            background: linear-gradient(145deg, #15334d 0%, #246d8e 100%);
        }

        .band-5 {
            background: linear-gradient(145deg, #1a2d60 0%, #3052c0 100%);
        }
            ...
            <div class="shrink-0 grid grid-cols-2 gap-3 max-w-xs w-full">
                @php
                    $heroStats = [
                        ...
                        ['icon' => '♾️', 'label' => 'Free forever', 'sub' => 'one approval = access'],
                ...
                <a href="{{ route('courses.view', $course) }}"
                    ...
                    <div class="p-6 flex flex-col flex-1">
                        <div class="flex items-center justify-between mb-4">
                            <span
                                class="pill text-[.68rem] font-extrabold uppercase tracking-[.07em] px-3 py-[.25rem] rounded-md bg-[#eff6ff] text-[#1b3a6b] border border-[rgba(27,58,107,.1)] transition-colors">
                                {{ $course->sections_count }} {{ Str::plural('section', $course->sections_count) }}
                            </span>
                        ...
                        {{-- Title — view-transition-name for morph --}}
