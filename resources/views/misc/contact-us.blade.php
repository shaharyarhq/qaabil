...
<head>
    ...
    <style>
        ...
        .contact-card:hover .contact-icon-wrap { background: #1b3a6b; }
        .contact-card:hover .contact-icon-wrap svg { stroke: #fff; }
...
<div class="hero bg-[#1b3a6b] relative overflow-hidden">
    <div class="absolute rounded-full pointer-events-none" style="width:500px;height:500px;background:radial-gradient(circle,rgba(245,158,11,.2) 0%,transparent 65%);top:-180px;right:-100px"></div>
    <div class="absolute rounded-full pointer-events-none" style="width:280px;height:280px;background:radial-gradient(circle,rgba(99,132,255,.12) 0%,transparent 65%);bottom:-80px;left:40px"></div>
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-6 py-20 text-center">
        <div class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-6" style="background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.25)">
            ...
            <span class="text-white/80 text-[.75rem] font-bold uppercase tracking-[.08em]">We'd love to hear from you</span>
        </div>
...
<main class="max-w-6xl mx-auto px-6 py-16 pb-28">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
        ...
        <div class="lg:col-span-2 flex flex-col gap-5">
            ...
            <a href="{{ $m['href'] }}"
               class="contact-card fu d{{ $i + 1 }} flex items-center gap-4 bg-white border border-[#e2e8f0] rounded-2xl p-5 no-underline text-inherit transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_-8px_rgba(27,58,107,.12)] hover:border-[rgba(27,58,107,.2)]">
                <div class="contact-icon-wrap w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-colors duration-200" style="background:rgba(27,58,107,.07)">
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#1b3a6b" stroke-width="1.8" class="transition-colors duration-200">
                        {!! $m['icon'] !!}
                    </svg>
                </div>
                <div class="min-w-0">
                    <p class="text-[.7rem] font-extrabold uppercase tracking-[.08em] text-[#94a3b8] mb-0.5">{{ $m['label'] }}</p>
            ...
            <div class="fu d4 bg-[#1b3a6b] rounded-2xl p-6 relative overflow-hidden">
                <div class="absolute rounded-full pointer-events-none" style="width:180px;height:180px;background:radial-gradient(circle,rgba(245,158,11,.18) 0%,transparent 70%);bottom:-60px;right:-40px"></div>
                <div class="relative z-10">
                    <div class="text-[#f59e0b] text-2xl mb-3">✦</div>
                    <p class="text-sm font-bold text-white mb-1">Built by the community</p>
                    <p class="text-xs text-white/50 leading-relaxed">
                        Qaabil is a passion project. We're a small team backed by a big community. Your message genuinely matters to us.
                    </p>
                </div>
            </div>
        ...
        <div class="lg:col-span-3 fu d2 bg-white border border-[#e2e8f0] rounded-3xl p-8 md:p-10">
            ...
            <div class="mb-8">
                <div class="inline-flex items-center gap-2 text-[.7rem] font-extrabold uppercase tracking-[.1em] text-[#1b3a6b] mb-2">
